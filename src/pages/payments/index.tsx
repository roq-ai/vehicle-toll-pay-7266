...
export function PaymentListPage(props: PaymentListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'toll_booth', 'journey.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('toll_booth', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('journey', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'journey',
          header: 'Journey',
          accessorKey: 'journey',
          cell: ({ row: { original: record } }: any) => record?._count?.journey,
        }
      : null,
