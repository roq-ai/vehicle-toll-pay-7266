  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless journeys with Vehicle Toll Payment System, your reliable partner for automatic toll collection on toll roads."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1465415327743-0ced16e06d7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0b2xsJTIwcm9hZHxlbnwwfHx8fDE2OTc3ODEwODR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@prostoroman?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Roman Logov`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless journeys with Vehicle Toll Payment System, your reliable partner for automatic toll collection on toll roads.`}
            </Text>
            <Box
