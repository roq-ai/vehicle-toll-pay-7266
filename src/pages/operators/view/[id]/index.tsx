...
import { useOperatorFindFirst, useRoqClient } from 'lib/roq';

import { OperatorInterface } from 'interfaces/operator';
import { TollBoothListPage } from 'pages/toll-booths';
...
function OperatorViewPage() {
  ...
  const { data, error, isLoading } = useOperatorFindFirst(queryParams, {}, { disabled: !id });
